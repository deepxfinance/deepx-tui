...
- the app now starts a shared market websocket session for the selected network during process boot and reuses that transport across market and position consumers
