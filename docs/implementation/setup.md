...
- `deepx_get_user_balance`, `deepx_list_subaccounts`, `deepx_create_subaccount`, `deepx_place_order`, `deepx_cancel_order`, `deepx_close_position`, and `deepx_update_position` are all available in the in-process tool registry
